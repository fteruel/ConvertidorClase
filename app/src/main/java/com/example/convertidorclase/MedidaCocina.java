...
public class MedidaCocina {
    ...
    public MedidaCocina(String nombreEntrada,
                        String medida1Entrada,
                        String medida2Entrada,
                        String medida3Entrada){

        this.nombre  = nombreEntrada;
        this.medida1 = medida1Entrada;
        this.medida2 = medida2Entrada;
        this.medida3 = medida3Entrada;
